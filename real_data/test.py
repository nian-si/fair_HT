...
if __name__ == "__main__":
    ...
    for i, N in enumerate(N_range):
        ...
        for rep in range(replications):
            ...
            dist = calculate_distance_eqopp(data_tuple, np.array([0, 1]), 0.7)
            s_hat.append(dist)
            asympt = limiting_dist_EQOPP(data_tuple, np.array([0, 1]), 0.7)
            threshold = asympt * chi2.ppf(.95, 1)
